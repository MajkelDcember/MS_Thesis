...
plt.title('Perplexity vs. Quantization Level (Wiki_last_mlp_layer)')
plt.grid(True, which="both", ls="--")

plt.savefig('perplexity_vs_quantization(Wiki_last_mlp_layer).png')
...
# plt.figure(figsize=(10, 5))
# plt.plot(vs, squared_differences, marker='o')
# plt.xscale('log')
# plt.xlabel('Quantization Level v')
# plt.ylabel('Squared Weight Difference')
# plt.title('Squared Weight Difference vs. Quantization Level v')
# plt.grid(True, which="both", ls="--")
# plt.savefig('Squared_Weight_Difference_vs_Quantization_Level(bookcorpus).png')
# plt.show()