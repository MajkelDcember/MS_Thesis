...
quantized_model_dir = "meta-llama/Llama-2-7b-chat-hf-4bit"
...
ax.set_title("GPTQ Llama-2-7b-chat-hf Performance")
ax.legend()
plt.grid(True)
plt.savefig('GPTQ Llama-2-7b-chat-hf Performance.png')
plt.show()
